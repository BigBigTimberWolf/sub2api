  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        userAgent: '账号 User-Agent',
        userAgentPlaceholder: '留空则使用上游默认 User-Agent',
        userAgentDesc:
          '仅对 OpenAI API Key 账号生效。OAuth 账号仍保持 Codex CLI 兼容请求头策略。',
      ...
      syncingModels: '同步中...',
      nvidiaApiKeyRequiredForSync: '请先填写 NVIDIA API Key',
      nvidiaModelsSyncFailed: '同步 NVIDIA 模型失败，已使用本地兜底模型',
